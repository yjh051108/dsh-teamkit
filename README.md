...
> ```
> ✅ **【已解决 · 2026-09-14】"能不能删人"这条已经落实** —— 底下那句"正在另起实验探究"是**旧话**
> （保留在此仅为对照：**从"底座根本不能删"到"插件层可以释放名额"是我们的成果**）：
...
> ⚠️ ~~**已知进行中的工作**：本项目正在**另起实验**探究"能不能在插件层让成员可释放"~~
> （**这句已过期，勿引用**：那项工作早已完成，见本节下面的结论与 `MEMBER-RELEASE.md`）。
>
